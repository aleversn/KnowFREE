...
class Trainer():
    ...
    def save_model(self, current_step=0, prefix=''):
        ...
        model_self.save_pretrained(
            f'./save_model/{dir}/knowfree{prefix}_{current_step}', safe_serialization=False)
        self.tokenizer.save_pretrained(f'./save_model/{dir}/knowfree{prefix}_{current_step}')
